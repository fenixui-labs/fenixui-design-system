...
export function useOverlayedComponent(): NodeCollection | null {
	...
	const [overlayedComponent, setOverlayedComponent] =
		useState<NodeCollection | null>(null);
...
export function getMousePostitionRelativeToCyCanvas(
	e: MouseEvent,
): OverlayedPosition {
	const cyWrapperDiv = document.getElementById("cyto-wrapper-div");
